...
const Footer = () => {
  return (
    <div className="mt-8">
      <footer className="w-full py-14 border-t-1 border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <a href="#" className="flex justify-center ">
             <h1 className="text-4xl text-amber-600 tracking-widest">LUXEDRIVE</h1>
            </a>
            <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
              <li>
                <a href="#" className="text-gray-800 hover:text-amber-800 ">
                  Luxedrive
                </a>
              </li>
              <li>
            ...
            <div className="flex space-x-10 justify-center items-center  mb-14">
              <a
                href="#"
                className="block  text-gray-900 transition-all duration-500 hover:text-amber-800 "
              >
                <svg
            ...
            <span className="text-lg text-gray-900 text-center block">
              ©<a href="#">Ahmet Sahin</a> 2025, All rights
              reserved.
            </span>
          </div>
        </div>
